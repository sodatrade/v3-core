...
describe('SodaTradeV3Pool', () => {
  ...
  let pool0: MockTimeSodaTradeV3Pool
  let pool1: MockTimeSodaTradeV3Pool
  ...
  let swapTargetCallee: TestSodaTradeV3Callee
  let swapTargetRouter: TestSodaTradeV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeSodaTradeV3Pool, any]> => {
