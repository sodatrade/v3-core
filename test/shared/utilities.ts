...
export function createPoolFunctions({
  ...
  swapTarget: TestSodaTradeV3Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeSodaTradeV3Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestSodaTradeV3Router
  poolInput: MockTimeSodaTradeV3Pool
  poolOutput: MockTimeSodaTradeV3Pool
}): MultiPoolFunctions {
