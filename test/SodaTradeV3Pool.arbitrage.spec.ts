...
import { SodaTradeV3PoolSwapTest } from '../typechain/SodaTradeV3PoolSwapTest'
...
describe('SodaTradeV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('SodaTradeV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as SodaTradeV3PoolSwapTest
          ...
          let tester: SodaTradeV3PoolSwapTest
